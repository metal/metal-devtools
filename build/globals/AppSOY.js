  ...
  */
	...
	var JSXRenderer = function (_IncrementalDomRender) {
		...
		function JSXRenderer() {
			...
			return babelHelpers.possibleConstructorReturn(this, (JSXRenderer.__proto__ || Object.getPrototypeOf(JSXRenderer)).apply(this, arguments));
		}
    ...
    */
			...
			key: 'generateKey',
			value: function generateKey(component, key) {
				key = babelHelpers.get(JSXRenderer.prototype.__proto__ || Object.getPrototypeOf(JSXRenderer.prototype), 'generateKey', this).call(this, component, key);
    ...
    */
			...
			value: function patch(component) {
				...
				babelHelpers.get(JSXRenderer.prototype.__proto__ || Object.getPrototypeOf(JSXRenderer.prototype), 'patch', this).call(this, component);
			}
    ...
    */
			...
			value: function renderIncDom(component) {
				if (component.render) {
					...
					babelHelpers.get(JSXRenderer.prototype.__proto__ || Object.getPrototypeOf(JSXRenderer.prototype), 'renderIncDom', this).call(this, component);
				}
			}
    ...
    */
			...
			value: function skipRender() {
				...
				babelHelpers.get(JSXRenderer.prototype.__proto__ || Object.getPrototypeOf(JSXRenderer.prototype), 'skipRender', this).call(this);
			}
		}]);
		return JSXRenderer;
	...
	this['metal']['JSXRenderer'] = jsxRenderer_;
}).call(this);
'use strict';
...
(function () {
  ...
  */
	...
	this['metal']['iDOMHelpers'] = scope.iDOMHelpers;
}).call(this);
'use strict';
...
(function () {
    ...
    */
			...
			value: function createState_(comp, config) {
				...
				data.props_.configState(object.mixin({}, config, getStaticProperty(ctor, 'PROPS', State.mergeState)));
    ...
    */
	...
	}(ComponentDataManager.constructor);

	this['metal']['JSXDataManager'] = new JSXDataManager();
}).call(this);
'use strict';
...
(function () {
	var Component = this['metal']['JSXComponent'];
	var Config = this['metalNamed']['JSXComponent']['Config'];
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      ie_open('div');
      itext('Go to:');
      ie_open('a', null, null, 'href', '/metal-devtools/jsx.html');
      itext('JSX example');
      ie_close('a');
      ie_open('h1');
      itext('Soy example');
